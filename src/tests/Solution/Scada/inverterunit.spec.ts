...
test.describe("Verify the functionalities of Inverter Unit ", async () => {
    test("INVERTER UNIT PRODUCTON STATUS ", async ({ page }) => {
        await dologin(page);
        await page.goto(`${getBaseUrl()}${routerlist.INVERTER_UNIT}`);
    ...
    test("INVERTER UNIT PR ", async ({ page }) => {
        await dologin(page);
        await page.goto(`${getBaseUrl()}${routerlist.INVERTER_UNIT}`);
        await new Promise(resolve => setTimeout(resolve, 5000));
    ...
    test("INVERTER UNIT INVERTER AVAILABILITY ", async ({ page }) => {
        await dologin(page);
        await page.goto(`${getBaseUrl()}${routerlist.INVERTER_UNIT}`);
        await new Promise(resolve => setTimeout(resolve, 5000));
        await page.locator('nz-select-arrow svg').click();
    ...
    test("INVERTER UNIT INVERTER EFFICIENCY ", async ({ page }) => {
        await dologin(page);
        await page.goto(`${getBaseUrl()}${routerlist.INVERTER_UNIT}`);
        await new Promise(resolve => setTimeout(resolve, 5000));
        await page.locator('nz-select-arrow svg').click();
    ...
    test("INVERTER UNIT SPECIFIC YIELD ", async ({ page }) => {
        await dologin(page);
        await page.goto(`${getBaseUrl()}${routerlist.INVERTER_UNIT}`);
        await new Promise(resolve => setTimeout(resolve, 5000));
        await page.locator('nz-select-arrow svg').click();
